---
name: speckit-okf-converged
description: Registrar o resultado de converge e sincronizar conhecimento somente quando convergido.
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: okf:commands/converged.md
---

Leia o resultado efetivamente produzido por $speckit-converge nesta
...
falhar, pare sem sync. Depois execute $speckit-okf-sync na sessão
